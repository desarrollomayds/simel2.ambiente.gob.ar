        ...
        function ResponsiveTabs() {
          ...
          var update_tabs = function () {
            ...
            var hasVerticalTabs = (numVisibleVerticalTabs > 0)
              if(numVisibleVerticalTabs<=0) {
                  TABS_OBJECT.tabsVerticalContainer.siblings(".dropdown-toggle").addClass("hidden");
              }
            TABS_OBJECT.tabsVerticalContainer.siblings(".dropdown-toggle").find(".count").html("M&aacute;s " + "(" + numVisibleVerticalTabs + ")");
          ...
          var setup = function () {
            ...
            TABS_OBJECT.tabsHorizontalContainer.after("<div class='nav navbar-nav navbar-right dropdown tabs-dropdown js-tabs-dropdown'> \
              <a href='#' class='dropdown-toggle' data-toggle='dropdown'><span class='count'>M&aacute;s </span><b class='caret'></b></a> \
              <ul class='dropdown-menu' role='menu'> \
              <div class='dropdown-header visible-xs'>\
                <p class='count'>M&aacute;s</p> \
          ...
          var myVar = setInterval(function(){ update_tabs(); clearInterval(myVar);}, 10);

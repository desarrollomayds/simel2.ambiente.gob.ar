...
<div style="width:868px; height:41px; float:left; background-color:#1F99CD">Operadores - <span class="subtit-seccion">&iquest;Cu&aacute;l es el estado de mi tramite?</span></div>
...
<div class="submenu"> 
<ul>
<li> <a href="operadores-quien.html">&iquest;Qui&eacute;n debe registrarse?</a></li>


<li><a href="operadores-leyes.html"> Leyes que reglamentan RP </a></li>
...
<a href="#" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image22','','images/ver-mas-on.gif',1)"><img src="images/ver-mas.gif" name="Image22" width="18" height="16" border="0" id="Image22" /></a></span></div>

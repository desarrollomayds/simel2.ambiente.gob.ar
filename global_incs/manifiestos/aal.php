...
<div style="width:868px; height:41px; float:left; background-color:#1F99CD">AAL<span class="subtit-seccion"></span> - <span class="subtit-seccion">(Autoridad Ambiental Local)</span></div>
...
<li><a href="aal-faq.php"> Preguntas Frecuentes</a></li>
...
<br />
<div align="right" style="margin:0px; padding:0px"><a href="generadores-quien.php" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image23','','images/ver-mas-on.gif',1)"><img src="images/ver-mas.gif" name="Image23" width="18" height="16" border="0" id="Image23" /></a></div>
<br />
</div>
</div>
...
<div class="estructura-cont"> 1)<span class="resaltar"> Ingresar la totalidad de los datos que se requieren en  el formulario</span> de solicitud de acceso al sistema de Manifiestos DRP que figura  como &ldquo;Solicitud de Acceso al Sistema de ManifiestoDRP&rdquo;<br />
  <br />
2) <span class="resaltar">Imprimir 2(dos) copias </span>de la solicitud y presentarla  ante la Direcci&oacute;n de Residuos Peligrosos.<br />
    <br />
    <br />
    <br />
      <div align="right" style="margin:0px; padding:0px"><a href="generadores-que.php" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image21','','images/ver-mas-on.gif',1)"><img src="images/ver-mas.gif" name="Image21" width="18" height="16" border="0" id="Image21" /></a></div>
...
<!-- deshabilitado
 <br />
  cual es el<br />
<span style=" line-height:32px">ESTADO</span><br />
<span style="font-size:20px">de mi </span> tramite</div>
<div class="estructura-cont"> <br />
  <br />
<br />
<br />
<div style="margin-left:65px">
  <p>Ingrese su n&uacute;mero deCUIT:<br />
    <label>
    <input  style="width:300px" type="text" name="textfield3" id="textfield3" />
    </label>
    <a href="#" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image22','','images/ver-mas-on.gif',1)"><img src="images/ver-mas.gif" name="Image22" width="18" height="16" border="0" id="Image22" /></a></p>
  </div>
</div>
</div>
<br />

...
<ul id="nav">
    ...
    <li><img src="images/separador-boton.gif" vspace="5" /></li>
	<li class="seleccionado"><a href="operadores.php">Operadores</a></li>
    <li><img src="images/separador-boton.gif" vspace="5" /></li>
...
<div style="width:868px; height:41px; float:left; background-color:#1F99CD">Operadores</div>
...
<ul>SUJETOS REGULADOS GENERALES Y PARTICULARES

<ul>Operador: 
<li> Plantas de tratamiento:</li>
<li> Plantas de disposici&oacute;n final:</li>
</ul>

<ul>Operador / Generador:
<li> Operador que realiza actividades de almacenamiento:</li>
<li> Operador con Equipo Transportable:</li>
<li> Operador - Exportador de Residuos Peligrosos:</li>
</ul>
</ul>
</div>
</div>
<div align="right" style="margin:0px; padding:0px"><a href="operadores-quien.php" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image23','','images/ver-mas-on.gif',1)"><img src="images/ver-mas.gif" name="Image23" width="18" height="16" border="0" id="Image23" /></a></div>
<br />
...
<div class="estructura-cont"> <br />
  <br />
    <span class="resaltar">Ingresar la totalidad de los datos </span>que se requieren en  el formulario de solicitud de acceso al sistema de SIMEL que figura  como &ldquo;Solicitud de Alta de Usuario SIMEL&rdquo;<br />
      <br />
      </div>

...
<div style="width:868px; height:41px; float:left; background-color:#1F99CD">Operadores - <span class="subtit-seccion">&iquest;Que necesito para Registrarme?</span></div>
...
<div class="submenu"> 
<ul>
<li> <a href="operadores-quien.php">&iquest;Qui&eacute;n debe registrarse?</a></li>
<li> <span class="submenu-seleccionado">&iquest;Qu&eacute; necesito para Registrarme?</span></li>

<li><a href="operadores-leyes.php"> Leyes que reglamentan RP </a></li>
...
<div id="contenido-submenu">1)<span class="resaltar">Ingresar la totalidad de los datos </span>que se requieren en  el formulario de solicitud de acceso al sistema de Manifiestos DRP que figura  como &ldquo;Solicitud de Acceso al Sistema de ManifiestoDRP&rdquo;<br />
  <br />
  2)
  <span class="resaltar">Imprimir 2(dos) copias</span> de la solicitud y presentarla  ante la Direcci&oacute;n de Residuos Peligrosos.</div>

<div class="backGrey">
    ...
    <table width="595" border="0" cellspacing="0" cellpadding="5">
		<tr>
			...
			<td width="328" bordercolor="#EAEAE5"><label><input type='text' name='transportista_criterio'     id='transportista_criterio'     value='' size='50'></label></td>
                        <td><div id='btn_buscar_transportistas'><img class="hand" src="/imagenes/boton_buscar.gif" width="91" height="30" /></div></td>
                </tr>
     ...
     <div class="clear20"></div>
    <table width="590" border="0" cellpadding="5" cellspacing="0" class="tabla">
		<tr>
    ...
    <div class="contBoton">
        ...
        <div class="bottonRight btn_cerrar2">
...
<script>
	...
	function llenar_lista_busqueda_transportistas(transportistas){
			...
			for(var indice in transportistas){
				...
				<tr>\
					...
					<td bgcolor='" + color + "' class='td' id='nombre'>"    + transportista["NOMBRE_EMPRESA"] + "</td>\
					<td bgcolor='" + color + "' class='td' id='cuit'>"      + transportista["CUIT"] + "</td>\
					<td bgcolor='" + color + "' class='td' id='provincia'>" + transportista["PROVINCIA_"] + "</td>\
					<td bgcolor='" + color + "' class='td' id='localidad'>" + transportista["LOCALIDAD_"] + "</td>\
					<td bgcolor='" + color + "' class='td' id='direccion'>" + transportista["CALLE"] + " - " + transportista["NUMERO"] + " - " + transportista["PISO"] + "</td>\
					<td align='center' bgcolor='" + color + "' ><div class='btn_agregar_resultado_transportista btn_cerrar2 hand'><img src='/imagenes/boton_agregar.gif'/></div></td>\
				</tr>";
	...
	$('.btn_agregar_resultado_transportista').live('click', function() {
		...
		$.ajax({
		   type: "POST",
		   url: "/operacion/transportista/transportista_edicion.php",

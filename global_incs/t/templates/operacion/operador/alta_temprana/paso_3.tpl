<html>
	<head>
		<title>registraci&oacute;n - paso 4</title>
...
<![endif]-->
	...
	<body style="text-align: center;">
		...
		<div id="apDiv1">Formulario - Paso 3<br /></div>
		...
		<div id="contenido-form">
			...
			<table width="780" border="0" cellpadding="5" cellspacing="0" class="tabla">
				<tr>
					<td colspan="7" bgcolor="#EAEAE5"><div align="right"><img src="/imagenes/boton_agregar.gif" width="91" height="30" id='btn_agregar_establecimiento' /></div></td>
				</tr>
			</table>
			...
			<a id='btn_anterior' href="paso_2.php"><img style="text-decoration: none;margin: 0;padding: 0;border: 0;outline: 0;" src="/imagenes/boton_anterior.gif"  width="91" height="30" border="0" /></a>
			<a id='btn_siguiente'><img style="text-decoration: none;margin: 0;padding: 0;border: 0;outline: 0;" src="/imagenes/boton_siguiente.gif" width="91" height="30" border="0" /></a>
		</div>
		</div>
	...
	<script type="text/javascript">
		...
		$('.btn_borrar_establecimiento').on('click', function() {
		...
		$('.btn_permisos_establecimiento').on('click', function() {
			...
			$.ajax({
			   type: "GET",
			   url: "/operacion/operador/alta_temprana/permisos_establecimiento.php?id=" + registro_actual.find('#id').html(),
			   dataType: "html",
		...
		$('.btn_editar_establecimiento').on('click', function() {
			registro_actual = $(this).parent().parent();
			$.ajax({
			   type: "GET",
			   url: "/operacion/operador/alta_temprana/establecimiento.php?id=" + registro_actual.find('#id').html(),
			   dataType: "html",
			   success: function(msg){
				$('#div_popup').html(msg);
				$('#div_popup').show();
		...
		$('#btn_siguiente').click(function() {
			var campos  = [	'establecimientos', 'permisos_establecimientos' ];

			$.ajax({
				type: "POST",
				url: "/operacion/operador/alta_temprana/paso_3.php",
				data: {	},
				dataType: "text json",
				success: function(retorno){
								if(retorno['estado'] == 0){

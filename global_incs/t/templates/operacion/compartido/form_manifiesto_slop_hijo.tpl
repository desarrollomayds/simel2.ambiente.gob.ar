<input type="hidden" id="manifiesto_padre" name="manifiesto_padre" value="{$MANIFIESTO.ID}"/>

<div class="alert alert-info" role="alert" style="font-weight:bold;">
	Ud est&aacute; por crear un manifiesto slop relacionado que se vincular&aacute; al manifiesto Nro {formatear_id_protocolo_manifiesto($MANIFIESTO.NUMERO_PROTOCOLO)}
</div>
...
<div class="table-responsive bs-example">
	...
	<table class="table table-hover table-striped">
		...
		<tbody>
			<tr>
				<td class="invisible">{$MANIFIESTO.GENERADORES[0].ID}</td>
				<td>{$MANIFIESTO.GENERADORES[0].NOMBRE_EMPRESA}</td>
				<td>{$MANIFIESTO.GENERADORES[0].CUIT}</td>
				<td>{$MANIFIESTO.GENERADORES[0].CALLE_R} {$MANIFIESTO.GENERADORES[0].NUMERO_R} {$MANIFIESTO.GENERADORES[0].PISO_R}</td>
				<td>{$MANIFIESTO.GENERADORES[0].NUMERO_TELEFONICO}</td>
			</tr>
		</tbody>
	</table>
</div>
...
<div class="table-responsive bs-example">
	...
	<table class="table table-hover table-striped">
		...
		<tbody>
			<tr>
				<td class="invisible">{$MANIFIESTO.OPERADORES[0].ID}</td>
				<td>{$MANIFIESTO.OPERADORES[0].NOMBRE_EMPRESA}</td>
				<td>{$MANIFIESTO.OPERADORES[0].CUIT}</td>
				<td>{$MANIFIESTO.OPERADORES[0].CALLE_R} {$MANIFIESTO.OPERADORES[0].NUMERO_R} {$MANIFIESTO.OPERADORES[0].PISO_R}</td>
				<td>{$MANIFIESTO.OPERADORES[0].EXPEDIENTE_NUMERO}/{$MANIFIESTO.OPERADORES[0].EXPEDIENTE_ANIO}</td>
				<td>{$MANIFIESTO.OPERADORES[0].CAA_NUMERO} - {$MANIFIESTO.OPERADORES[0].CAA_VENCIMIENTO}</td>
			</tr>
		</tbody>
	</table>
</div>
...
<div class="table-responsive bs-example">
	...
	<table class="table table-hover table-striped">
		...
		<tbody>
			<tr>
				{foreach $MANIFIESTO.RESIDUOS as $res}
					<td>{$res.RESIDUO}</td>
					<td>{$res.ESTADO_}</td>
					<td>{$res.CANTIDAD_CONTENEDORES}</td>
					<td>{$res.CANTIDAD_ESTIMADA}</td>
				{/foreach}
			</tr>
		</tbody>
	</table>
...
{include file='general/popup.tpl' ID_POPUP='vehiculo'}

    ...
    <body style="text-align: center;">
        ...
        <div style="width:800px;height:600px; background-color: #F5F5ED;margin: auto;margin-top: 50px;">
            ...
            <div class="mailMenu" style="margin: auto;width:600px;height: 400px;text-align: left;overflow:auto;">
                ...
                <input type="text" style="height:20px;width: 530px;margin: auto;" class="wide" value=""  id="mensaje_titulo" name="mensaje_titulo">
                <br/>
                <br/>
                ...
                <input type="submit" style="margin:0px 0px 0px 15px; " value="Enviar"    id="btn_enviar" class="generic" name="preview_post">
...
{literal}
  <script>
  	...
  	$('#btn_enviar').click(function() {
  		...
  		$.ajax({
  			type: "POST",
  			url: "/operacion/generador/mensajeria/redactar_mensaje.php",

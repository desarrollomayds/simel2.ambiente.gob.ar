<p>Por medio del presente, el Ministerio de Ambiente y Desarrollo Sustentable de la Nación le informa que el manifiesto con número de protocolo <b>{formatear_id_protocolo_manifiesto($manifiesto->id_protocolo_manifiesto)}</b>, ha vencido automáticamente al haber alcanzado 30 días sin ser recibido por el operador.<p>

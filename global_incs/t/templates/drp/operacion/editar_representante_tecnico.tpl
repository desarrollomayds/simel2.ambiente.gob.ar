<div class="backGrey">
    ...
    <table width="495" border="0" cellspacing="0" cellpadding="5" style="font-size: 11px;">
        ...
        <tr>
            ...
            <td width="328" bordercolor="#EAEAE5"><label><input type='text'   name='resp_nombre'   id='resp_nombre'   value='{$REPRESENTANTE.NOMBRE}' size='30'></label></td>
        </tr>

        <tr>
            <td width="147" height="25" align="right" bordercolor="#EAEAE5">Apellido :</td>
            <td width="328" bordercolor="#EAEAE5"><label><input type='text'   name='resp_apellido' id='resp_apellido'   value='{$REPRESENTANTE.APELLIDO}' size='30'></label></td>
        </tr>

        <tr>
            <td width="147" height="25" align="right" bordercolor="#EAEAE5">Fecha de nacimiento :</td>
            <td width="328" bordercolor="#EAEAE5"><label><input type='text'   name='resp_fecha_nacimiento' id='resp_fecha_nacimiento'   value='{$REPRESENTANTE.FECHA_NACIMIENTO}' size='30' readonly="true"><input type='button' value='...' id='btn_cal_resp_fecha_nacimiento'></label></td>
        </tr>
        ...
        <tr>
            ...
            <td width="328" bordercolor="#EAEAE5"><label><input type='text'   name='resp_nro_doc'  id='resp_nro_doc'  maxlength='9' value='{$REPRESENTANTE.NUMERO_DOCUMENTO}' size='30'></label></td>
        </tr>

        <tr>
            <td width="147" height="25" align="right" bordercolor="#EAEAE5">Cargo :</td>
            <td width="328" bordercolor="#EAEAE5"><label><input type='text'   name='resp_cargo'     id='resp_cargo'     value='{$REPRESENTANTE.CARGO}' size='30'></label></td>
        </tr>

        <tr>
            <td width="147" height="25" align="right" bordercolor="#EAEAE5">Cuit :</td>
            <td width="328" bordercolor="#EAEAE5"><label><input type='text'   name='resp_cuit'     id='resp_cuit'     maxlength='11' value='{$REPRESENTANTE.CUIT}' size='30'></label></td>
        </tr>
...
<script>
            ...
            type: "POST",
                    ...
                    data:	{	id               : {/literal}{$REPRESENTANTE.ID}{literal},

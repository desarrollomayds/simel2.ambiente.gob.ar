...
-->
					<!--<table border="0" cellpadding="5" cellspacing="0" class="tablaBuscar">
						<tr>
							<td bgcolor="#EAEAE5" class="">Criterio :</td>
							<td bgcolor="#EAEAE5" class=""><input type='text' name='criterio' value=''></td>
                                                        <td colspan=2 bgcolor="#EAEAE5" align="center">
			...
			<table width="769" border="0" cellpadding="5" cellspacing="0" class="tabla" id="lista_resp_legales" style="font-size: 14px;">
				...
				<tr>
					...
					<td align="center" bgcolor="{$COLOR_LINEA}" class="td"><a href='/operacion/detalle_cambio.php?id={$PENDIENTE.ID}'>ver detalle</a></td>
				</tr>
				{/foreach}
			</table>
			<div style="float:right; margin-top:25px;">P&aacute;ginas
				...
				{foreach $PAGINAS as $PAGINA}
					<a href="/operacion/cambios_pendientes.php?p={$PAGINA+1-1}">{$PAGINA+1}</a>&nbsp;
				{/foreach}
			</table></div>
			<br/>

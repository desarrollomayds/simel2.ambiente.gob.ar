<div class="backGrey">
	...
	<input type='hidden' name='permiso_vehiculo'        id='permiso_vehiculo' value='{$VEHICULO}' size='50'>
...
$('#bigscreen').hide();
	...
	$('#btn_aceptar_2').click(function() {
		var campos  = [	'accion', 'vehiculo', 'id', 'residuo', 'cantidad', 'estado', 'fecha_inicio', 'fecha_fin', 'general' ];
		var prefijo = 'permiso';

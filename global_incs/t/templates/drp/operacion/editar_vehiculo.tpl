<div class="backGrey">
    ...
    <table width="495" border="0" cellspacing="0" cellpadding="5">
        <tr>
            ...
            <td width="328" bordercolor="#EAEAE5"><label><input type='text'   name='vehiculo_dominio'     id='vehiculo_dominio'     value='{$VEHICULO.DOMINIO}' size='50'></label></td>
        </tr>

        <tr>
            <td width="147" height="25" align="right" bordercolor="#EAEAE5">Descripci&oacute;n :</td>
            <td width="328" bordercolor="#EAEAE5"><label><input type='text'   name='vehiculo_descripcion'     id='vehiculo_descripcion'     value='{$VEHICULO.DESCRIPCION}' size='50'></label></td>
        </tr>
...
<script>
            ...
            type: "POST",
                    ...
                    data:	{	id                : {/literal}{$VEHICULO.ID}{literal},

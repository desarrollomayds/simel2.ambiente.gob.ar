<html>
	<head>
		<title>Admin - Bandeja de salida</title>
	...
	<body>
		...
		<div id="contenedor-interior">
			...
			<div id="apDiv1">Mensajes enviados</div>
           ...
           <div class="mailMenu" style="margin: auto;">
            ...
            <table width="100%" border="0" cellpadding="5" cellspacing="0" style="font-size: 13px;">
				<tr style="height: 15px;">
					<td bgcolor="#A8D8EA" class="td" align="center"><strong>ASUNTO</strong></td>
					...
					<td bgcolor="#A8D8EA" class="td" align="center"><strong>E-MAIL</strong></td>
				</tr>
            ...
            {foreach from=$MENSAJES key=k item=MENSAJE }
                <tr style="border-bottom:1px solid #A4A4A4; height: 35px;">
                  ...
                  <td class="hand">{utf8_decode($MENSAJE.TITULO)}</td>
              ...
              <div class="clear20"></div>
	            ...
	            <table align="center">
					{foreach $PAGINAS as $PAGINA}
						<a href="{$ADMIN_PATH}/operacion/bandeja_de_salida.php?p={$PAGINA+1-1}"> {$PAGINA+1} </a>
					{/foreach}
				</table>
				</div>
        </div></div>

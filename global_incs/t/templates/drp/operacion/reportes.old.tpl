...
<![endif]-->
	...
	<body>
		<div id="contenedor-form"><div id="logo"><img src="/imagenes/logo.gif" width="179" height="83" vspace="5" /></div>
...
<td class="td" style="background-color:#A8D8EA;">Fecha Inicio(dd/mm/aaaa)</td>
<td class="td" style="background-color:#A8D8EA;">Fecha Final(dd/mm/aaaa)</td>
<td class="td" style="background-color:#A8D8EA;">Generar reporte</td>
<td class="td" style="background-color:#A8D8EA;">Descargar Excel</td>
</tr>
	<form method="post" action="reportes/reporte_protocolo_manifiestos.php" target="foo" onSubmit="window.open('', 'foo', 'width=1024,height=500,status=yes,resizable=yes,scrollbars=yes')"
		<tr>
		<td class="td">Protocolo de manifiestos</td>
		<td class="td"><input type="text" name="fecha_desde"/></td>
		<td class="td"><input type="text" name="fecha_hasta"/></td>

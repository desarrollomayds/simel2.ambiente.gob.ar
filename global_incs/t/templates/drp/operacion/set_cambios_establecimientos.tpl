	...
	<div class="bs-example">
		...
		<form class="form-horizontal">
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<input class="form-control" name='calle' id='calle' value="{$cambio->calle}" disabled>
				</div>
			</div>
			...
			<div class="form-group">
				<label class="col-sm-2 control-label">Calle</label>
				<div class="col-sm-10">
					<input class="form-control" name='calle_c' id='calle_c' value="{$cambio->calle_c}" disabled>
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<input class="form-control" name='habilitaciones' id='habilitaciones' value="{$cambio->habilitaciones}" disabled>
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<input class="form-control" name='email' id='email' value="{$cambio->email}" disabled>
				</div>
			</div>
		</form>

<div class="backGrey">
    ...
    <table width="495" border="0" cellspacing="0" cellpadding="5" style="font-size: 11px;">
		...
		<tr>
			...
			<td width="328" bordercolor="#EAEAE5"><label><input type='text'   name='resp_nombre'   id='resp_nombre'   value='' size='30'></label></td>
		</tr>

		<tr>
			<td width="147" height="25" align="right" bordercolor="#EAEAE5">Apellido :</td>
			<td width="328" bordercolor="#EAEAE5"><label><input type='text'   name='resp_apellido' id='resp_apellido'   value='' size='30'></label></td>
		</tr>

		<tr>
			<td width="147" height="25" align="right" bordercolor="#EAEAE5">Fecha de nacimiento :</td>
			<td width="328" bordercolor="#EAEAE5"><label><input type='text'   name='resp_fecha_nacimiento' id='resp_fecha_nacimiento'   value='' size='30' readonly="true"><input type='button' value='...' id='btn_cal_resp_fecha_nacimiento'></label></td>
		</tr>
		...
		<tr>
			...
			<td width="328" bordercolor="#EAEAE5"><label><input type='text'   name='resp_cargo'     id='resp_cargo'     value='' size='30'></label></td>
		</tr>

...
<div align="right"><img width="115" height="27" id="" src="/imagenes/volver_inicio.gif"/></div>
                ...
                <div style="width:90%;background-color:white; border: 1px solid grey;text-align:left;">
<div style="margin:5px;">
		<b>Empresa:</b>mi empresa<br/>
		<b style="color:#777777;">Fecha:	12/12/11</b><br/>
		<p class="mensaje"> <b>Mensaje:<br/></b>sakhdlsdjhsfdlhfsdlsdhl sfdlkjflksd sdlkjflksfjdlf </p>

<br/><br/>
<b>DRP:</b>mi empresa<br/>
		<b style="color:#777777;">Fecha:	12/12/11</b><br/>
		<p class="mensaje"> <b>Mensaje:<br/></b>	sakhdlsdjhsfdlhfsdlsdhl sfdlkjflksd sdlkjflksfjdlf </p>
...
<br/><br/>
		<b>Empresa:</b>mi empresa<br/>
		<b style="color:#777777;">Fecha:	12/12/11</b><br/>
		<p class="mensaje"> <b>Mensaje:<br/></b>sakhdlsdjhsfdlhfsdlsdhl sfdlkjflksd sdlkjflksfjdlf sakhdlsdjhsfdlhfsdlsdhl sfdlkjflksd sdlkjflksfjdlf sakhdlsdjhsfdlhfsdlsdhl sfdlkjflksd sdlkjflksfjdlf sakhdlsdjhsfdlhfsdlsdhl sfdlkjflksd sdlkjflksfjdlf sakhdlsdjhsfdlhfsdlsdhl sfdlkjflksd sdlkjflksfjdlf</p>

<br/><br/>
<div style="widht:95%;height:2px; background-color:#777777;"></div>
<div class="" style="width:80%;margin-left:10px;">
                       <textarea class="TextoMensaje" style="width:95%; height:70px;margin-left:8px;"></textarea>   
                    </div><br/> <br/>
                    <div style="margin-left:30px;"><input type="button" value="enviar" class="ui-el-minibutton"/></div>
<br/> <br/>
		</div></div>
                    <br/>

...
<script>
	...
	{	
		...
		$.ajax({
		   type: "GET",
		   url: mel_path+"/registracion/permiso_establecimiento.php?rol={/literal}{$ROL_ID}{literal}&establecimiento={/literal}{$ESTABLECIMIENTO.ID}{literal}&id=" + PermisoID,
		   dataType: "html",
	...
	{	
		...
		$.ajax({
			type: "GET",
			url: mel_path+"/registracion/permiso_establecimiento.php?rol={/literal}{$ROL_ID}{literal}&establecimiento={/literal}{$ESTABLECIMIENTO.ID}{literal}",
			dataType: "html",
			success: function(msg){

<div class="backGrey">
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="5" style="font-size: 13px;">
        <tr>
            ...
            <td bordercolor="#EAEAE5"><input type='text'   name='resp_nombre'   id='resp_nombre'   value='{$REPRESENTANTE.NOMBRE}' size='30'></td>
        </tr>
        ...
        <tr>
            ...
            <td bordercolor="#EAEAE5"><input type='text'   name='resp_apellido' id='resp_apellido'   value='{$REPRESENTANTE.APELLIDO}' size='30'></td>
        </tr>
        ...
        <tr>
            ...
            <td bordercolor="#EAEAE5"><input type='text'   name='resp_cargo'     id='resp_cargo'     value='{$REPRESENTANTE.CARGO}' size='30'></td>
        </tr>

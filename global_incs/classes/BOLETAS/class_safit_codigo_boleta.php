 ...
 * @access public
 */
class safit_codigo_boleta extends safit{
	...
	/**
	 * safit_codigo_boleta::generar_codigo_boleta()
	 *
	...
	/**
	 * safit_codigo_boleta::digito_verificador_mod31()
	 *
	...
	/**
	 * safit_codigo_boleta::createCode()
	 *
	...
	public function createCode($codebars){
		...
		if ($obj){
			if ($obj->DrawObject(XRES))
				return "<img class='IMG_barcode_boleta' src='".$_PROTO_S."://".$_SERVER['HTTP_HOST']."/includes/barcode/image.php?code=".$codebars."&style=".$style."&type=".TYPE."&width=".WIDTH."&height=".HEIGHT."&xres=".XRES."&font=".FONT."'>";
	...
	/**
	 * safit_codigo_boleta::getNroConvenio()
	 *
	 * @return
	 */
	...
	/**
	 * safit_codigo_boleta::get_nroCta()
	 *
	 * @return
	 */
	...
	/**
	 * safit_codigo_boleta::get_descrCta()
	 *
	 * @return
	 */
   ...
   */
	...
	/**
	 * safit_codigo_boleta::set_roConvenio()
	 *
	...
	/**
	 * safit_codigo_boleta::set_nroCta()
	 *
	 * @param mixed $nroCta
	 * @return
	 */
	...
	/**
	 * safit_codigo_boleta::set_descrCta()
	 *
	...
	/**
	 * safit_codigo_boleta::setBanco()
	 *
	 * @return
	 */
	private function setBanco(){
		$metodo = "safit_codigo_".$this->get_banID();

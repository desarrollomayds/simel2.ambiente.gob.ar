...
<div style="width:868px; height:41px; float:left; background-color:#1F99CD">AAL<span class="subtit-seccion"></span> - <span class="subtit-seccion">(Autoridad Ambiental Local)</span> <span class="subtit-seccion">&iquest;Cu&aacute;l es el estado de mi tr&aacute;mite?</span></div>
...
<li><a href="aal-tramite.php"><span class="submenu-seleccionado">&iquest;Cu&aacute;l es el estado de mi tramite?</span></a></li>
...
<div id="contenido-seccion-der">
  <div id="contenido-submenu">Permite  saber dado un Nro. de CUIT si el usuario habilitado para el uso de manifiestos.<span class="resaltar"><br />
      <br />
Ingrese su n&uacute;mero de CUIT:<br />
<label>
<input  style="width:300px" type="text" name="textfield3" id="textfield3" />
</label>
<a href="#" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image22','','images/ver-mas-on.gif',1)"><img src="images/ver-mas.gif" name="Image22" width="18" height="16" border="0" id="Image22" /></a></span><br />
  </div>
  <br />

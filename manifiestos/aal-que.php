...
<div style="width:868px; height:41px; float:left; background-color:#1F99CD">AAL<span class="subtit-seccion"></span> - <span class="subtit-seccion">(Autoridad Ambiental Local)</span> <span class="subtit-seccion">&iquest;Qu&eacute; necesito para registrarme?</span></div>
...
<li> <a href="aal-que.php"><span class="submenu-seleccionado">&iquest;Qu&eacute; necesito para Registrarme?</span></a></li>
...
<div id="contenido-seccion-der">
  <div id="contenido-submenu">1)<span class="resaltar"> Ingresar la totalidad de los datos que se requieren en  el formulario</span> de solicitud de acceso al sistema de Manifiestos DRP que figura  como &ldquo;Solicitud de Acceso al Sistema de ManifiestoDRP&rdquo;<br />
    <br />

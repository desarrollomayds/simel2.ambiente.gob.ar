...
$mensajes = obtener_mensajes_por_establecimiento($_SESSION['INFORMACION_GENERAL']['ESTABLECIMIENTO']['ID'], SENTIDO_ESTABLECIMIENTO, 'p', $p);
...
$mensajesLeidos = obtener_mensajes_por_establecimiento($_SESSION['INFORMACION_GENERAL']['ESTABLECIMIENTO']['ID'], SENTIDO_ESTABLECIMIENTO, 'l', $p);
...
$smarty->assign('MENSAJESLEIDOS', $mensajesLeidos);
...
$smarty->display('operacion/compartido/mensajeria/bandeja_de_entrada.tpl');

<?
	...
	if(!isset($_SESSION['PASOS_CORRECTOS']) or !in_array(1, $_SESSION['PASOS_CORRECTOS'])){
		header("Location: /operacion/operador/alta_temprana/paso_1.php");
		exit;
	}
...
#			$_SESSION['DATOS_EMPRESA']['PROVINCIA_C']             = $_POST['provincia_c'];
			...
			$retorno['siguiente'] = '/operacion/operador/alta_temprana/paso_3.php';
		...
		$smarty->display('operacion/operador/alta_temprana/paso_2.tpl');	
	}

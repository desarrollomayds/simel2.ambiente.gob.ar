<?
	...
	if(!isset($_SESSION['PASOS_CORRECTOS']) or !in_array(2, $_SESSION['PASOS_CORRECTOS'])){
		header("Location: /operacion/operador/alta_temprana/paso_2.php");
		exit;
	}
	...
	if($_SERVER['REQUEST_METHOD'] == 'POST'){
		...
		if(!count($errores)){
			$retorno['siguiente'] = '/operacion/operador/alta_temprana/paso_4.php';
		...
		$smarty->display('operacion/operador/alta_temprana/paso_3.tpl');
	}
